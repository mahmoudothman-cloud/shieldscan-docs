...
**Tech Stack:** FastAPI, SQLAlchemy 2.0, Alembic, Pydantic v2, React 18, TypeScript, Tailwind, Vite, Go 1.22, asynq, Nuclei SDK, Docker SDK, MobSF REST API, PostgreSQL 16, Redis 7, Qdrant, Claude API, OpenAI Embeddings, Stripe, Cloudflare R2.
